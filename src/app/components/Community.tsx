  ...
  return (
    <section className="mt-28">
      ...
      <h1 className="text-xl font-semibold mb-3 text-gray-700 text-center flex items-center justify-center gap-2">
        ...
        <span className="text-primary">React Meetup in Montréal, Canada</span>
      </h1>
      ...
      <h1 className="mt-20 text-xl font-semibold mb-3 text-gray-700 text-center flex items-center justify-center gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6 text-red-400"
          fill="currentColor"
